...
<title>Insert title here</title>
      ...
      <link rel="stylesheet" type="text/css" href="././GroupProduct.css"/>
		...
		<fmt:message bundle="${loc}" key="local.favorites" var="favorites" />		
		<fmt:message bundle="${loc}" key="local.favorites.delete" var="delete" />
...
<div class="container mt-5">
    ...
    <h3 class="font-weight-bold mb-4 pb-2">${favorites}</h3>

<div class="container cont">
    <div class="row">

     <c:forEach items="${groupProductFavorites}" var="product">
        <div class="col-md-3 col-sm-6">
            <div class="product-grid6">
                ...
                <ul class="social">
                    <li><a href="Controller?command=delete_product_favorites&productId=${product.id}" data-tip="${delete}"><i class="fas fa-trash"></i></a></li>
