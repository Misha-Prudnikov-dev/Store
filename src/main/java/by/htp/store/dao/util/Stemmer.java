...
public class Stemmer {
	...
	private static final Pattern ADJECTIVE = Pattern
			.compile("(ее|ие|ые|ое|ими|ыми|ей|ий|ый|ой|ем|им|ым|ом|его|ого|ему|ому|их|ых|ую|юю|ая|яя|ою|ею)$");
	...
	public String prepareLine(String line) {
		...
		String[] search1 = line.split(" ");
		String search2 = " ";

		for (String str : search1) {

			search2 = search2 + " " + stem(str);

		}

		search2 = search2.trim();
		search2 = search2.replaceAll("\\s{1,}", "*+");
