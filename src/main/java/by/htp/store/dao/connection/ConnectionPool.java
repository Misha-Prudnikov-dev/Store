...
import by.htp.store.dao.connection.DBParameter;
import by.htp.store.dao.connection.DBResourceManager;
...
public class ConnectionPool {
	...
	private ConnectionPool() throws ClassNotFoundException, SQLException, IOException {
		...
		dbResourceManager.getPropValue();System.out.println("1");
	...
	public void initPoolData() throws ClassNotFoundException, SQLException {
		...
		Class.forName(driverName);System.out.println("0");
